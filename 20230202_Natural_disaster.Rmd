...
Exploring the disaster types a little bit further, we can detect in the boxplot below that fires show the largest variation in terms of duration. Dam or Levee breaks, volcanic eruptions, tornados and severe ice storms are amongst the disasters with the shortest durations. 
...
ggplot(data = df.prep.5, 
  ...
  theme_minimal()
```
With the transformed data, we could generate a plot showing the damage disasters have cause per state in the US over the past 20 years:
