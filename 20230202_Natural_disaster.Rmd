...
ggplot(diff_approved, mapping = aes(x = Type, y = difference)) +
  geom_boxplot(color = "green4", fill = "green", alpha = 0.5) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "", y = "Difference Damage and Approved $")
```

### Approved and actually used 
